...
public class IntelligenceModifier extends DiceModifier {
    private final int modifier;

    public IntelligenceModifier(DiceBase diceRoll, int modifier) {
        super(diceRoll);
    ...
    public String getName() {
        return diceRoll.getName() + ", Intelligence";
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IntelligenceModifier that)) return false;
