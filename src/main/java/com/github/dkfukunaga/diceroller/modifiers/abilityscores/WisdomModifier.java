...
public class WisdomModifier extends DiceModifier {
    private final int modifier;

    public WisdomModifier(DiceBase diceRoll, int modifier) {
        super(diceRoll);
    ...
    public String getName() {
        return diceRoll.getName() + ", Wisdom";
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WisdomModifier that)) return false;
